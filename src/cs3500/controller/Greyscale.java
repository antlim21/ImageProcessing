...
/**
 * Represents the operation for the Greyscale method.
 */
public class Greyscale implements PhotoshopCommand {
   ...
   */
  public Greyscale(boolean quit, String arg2, String arg3) {
    this.quit = quit;
    this.arg2 = arg2;
    this.arg3 = arg3;
  }
  ...
  /**
   * Executes the greyscale() method on the given model as long as the user has not already
   * quit.
   *
   * @param model The model that will execute the Greyscale Operation.
  ...
  public void run(PhotoshopAdditionalOperationsInterface model, PhotoshopViewInterface view)
    ...
    if (!this.quit) {
      try {
        model.greyscale(this.arg2, this.arg3);
        view.renderMessage("Successfully grey-scaled \n");
