...
/**
 * Represents the operation for the Blue Component method.
 */
public class BlueComponent implements PhotoshopCommand {
   ...
   */
  public BlueComponent(boolean quit, String arg2, String arg3) {
    this.quit = quit;
    this.arg2 = arg2;
    this.arg3 = arg3;
  }
  ...
  /**
   * Executes the blue-component() method on the given model as long as the user has not already
   * quit.
   *
   * @param model The model that will execute the Blue Component Operation.
  ...
  public void run(PhotoshopAdditionalOperationsInterface model, PhotoshopViewInterface view)
    ...
    if (!this.quit) {
      try {
        model.blueComponent(this.arg2, this.arg3);
        view.renderMessage("Successfully grey-scaled via blue component \n");
