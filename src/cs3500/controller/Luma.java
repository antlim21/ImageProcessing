...
/**
 * Represents the operation for the Luma method.
 */
public class Luma implements PhotoshopCommand {
   ...
   */
  public Luma(boolean quit, String arg2, String arg3) {
    this.quit = quit;
    this.arg2 = arg2;
    this.arg3 = arg3;
  }
  ...
  /**
   * Executes the luma-component() method on the given model as long as the user has not already
   * quit.
   *
   * @param model The model that will execute the Luma Operation
  ...
  public void run(PhotoshopAdditionalOperationsInterface model, PhotoshopViewInterface view)
    ...
    if (!this.quit) {
      try {
        model.luma(this.arg2, this.arg3);
        view.renderMessage("Successfully grey-scaled via luma component \n");
