...
/**
 * Represents the operation for the Sepia method.
 */
public class Sepia implements PhotoshopCommand {
   ...
   */
  public Sepia(boolean quit, String arg2, String arg3) {
    this.quit = quit;
    this.arg2 = arg2;
    this.arg3 = arg3;
  }
  ...
  /**
   * Executes the sepia-component() method on the given model as long as the user has not already
   * quit.
   *
   * @param model The model that will execute the Sepia Operation
  ...
  public void run(PhotoshopAdditionalOperationsInterface model, PhotoshopViewInterface view)
    ...
    if (!this.quit) {
      try {
        model.sepia(this.arg2, this.arg3);
        view.renderMessage("Successfully applied sepia filter onto image \n");
