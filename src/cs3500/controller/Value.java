...
/**
 * Represents the operation for the Value method.
 */
public class Value implements PhotoshopCommand {
   ...
   */
  public Value(boolean quit, String arg2, String arg3) {
    this.quit = quit;
    this.arg2 = arg2;
    this.arg3 = arg3;
  }
  ...
  /**
   * Executes the value() method on the given model as long as the user has not already
   * quit.
   *
   * @param model The model that will execute the Value Operation.
  ...
  public void run(PhotoshopAdditionalOperationsInterface model, PhotoshopViewInterface view)
    ...
    if (!this.quit) {
      try {
        model.value(this.arg2, this.arg3);
        view.renderMessage("Successfully grey-scaled via value component \n");
