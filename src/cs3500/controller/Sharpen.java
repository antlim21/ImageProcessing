...
/**
 * Represents the operation for the Sharpen method.
 */
public class Sharpen implements PhotoshopCommand {
   ...
   */
  public Sharpen(boolean quit, String arg2, String arg3) {
    this.quit = quit;
    this.arg2 = arg2;
    this.arg3 = arg3;
  }
  ...
  /**
   * Executes the sharpen() method on the given model as long as the user has not already
   * quit.
   *
   * @param model The model that will execute the Sharpen Operation.
  ...
  public void run(PhotoshopAdditionalOperationsInterface model, PhotoshopViewInterface view)
    ...
    if (!this.quit) {
      try {
        model.sharpen(this.arg2, this.arg3);
        view.renderMessage("Successfully sharpened image \n");
