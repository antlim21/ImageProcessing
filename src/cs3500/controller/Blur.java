...
/**
 * Represents the operation for the Blur method.
 */
public class Blur implements PhotoshopCommand {
   ...
   */
  public Blur(boolean quit, String arg2, String arg3) {
    this.quit = quit;
    this.arg2 = arg2;
    this.arg3 = arg3;
  }
  ...
  /**
   * Executes the blur() method on the given model as long as the user has not already
   * quit.
   *
   * @param model The model that will execute the Blur Operation.
  ...
  public void run(PhotoshopAdditionalOperationsInterface model, PhotoshopViewInterface view)
    ...
    if (!this.quit) {
      try {
        model.blur(this.arg2, this.arg3);
        view.renderMessage("Blur successful\n");
