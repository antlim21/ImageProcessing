...
/**
 * Represents the operation for the Vertical Flip method.
 */
public class VerticalFlip implements PhotoshopCommand {
   ...
   */
  public VerticalFlip(boolean quit, String arg2, String arg3) {
    this.quit = quit;
    this.arg2 = arg2;
    this.arg3 = arg3;
  }
  ...
  /**
   * Executes the verticalFlip() method on the given model as long as the user has not already
   * quit.
   *
   * @param model The model that will execute the Vertical Flip Operation
  ...
  public void run(PhotoshopAdditionalOperationsInterface model, PhotoshopViewInterface view)
    ...
    if (!this.quit) {
      try {
        model.verticalFlip(this.arg2, this.arg3);
