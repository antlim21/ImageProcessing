...
/**
 * Represents the operation for the Red Component method.
 */
public class RedComponent implements PhotoshopCommand {
   ...
   */
  public RedComponent(boolean quit, String arg2, String arg3) {
    this.quit = quit;
    this.arg2 = arg2;
    this.arg3 = arg3;
  }
  ...
  /**
   * Executes the red-component() method on the given model as long as the user has not already
   * quit.
   *
   * @param model The model that will execute the Red Component Operation
  ...
  public void run(PhotoshopAdditionalOperationsInterface model, PhotoshopViewInterface view)
    ...
    if (!this.quit) {
      try {
        model.redComponent(this.arg2, this.arg3);
        view.renderMessage("Successfully grey-scaled via red component \n");
